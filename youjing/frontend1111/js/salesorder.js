        ...
        _.http.post("/api/saier/salesorder/save/before", {
            ...
            for (let r of v) {
                ...
                if (r[recordset.module.field_by_full_name(n + '.产品资料.暗佣单价').db.name] > 0) {
                    ...
                    r[recordset.module.field_by_full_name(n + '.产品资料.暗佣单价').db.name] = Math.floor((aydj + 0.0000001) * 10000) / 10000;
                }
                if (r[recordset.module.field_by_full_name(n + '.产品资料.佣金单价').db.name] > 0) {
                    ...
                    r[recordset.module.field_by_full_name(n + '.产品资料.佣金单价').db.name] = Math.floor((mydj + 0.0000001) * 10000) / 10000;
                }
                ...
                if (r[recordset.module.field_by_full_name(n + '.产品资料.预计船期').db.name] == '') {
...
const salesorder_field_change = (evt_id, opts) => {
    ...
    if (field.full_name == n + '.产品资料.外销单价' || field.full_name == n + '.产品资料.客户RMB单价' || field.full_name == '外销合同.产品资料.合同数量' || field.full_name == n + '.产品资料.刷新单价' ||
        ...
        if (recordset.value('自动计算含佣价') == '否' && recordset.value('佣金类型') == '明佣+暗佣' && recordset.value('产品资料.单证锁定', row) == '') {
            if (recordset.value('RMB客户') != '是') {
                recordset.val('产品资料.含佣单价', Math.floor((recordset.value('产品资料.外销单价', row) + recordset.value('产品资料.佣金单价', row) + recordset.value('产品资料.暗佣单价', row) + 0.0000001) * 10000) / 10000, row);
                ...
                recordset.val('产品资料.含佣RMB单价', Math.floor((recordset.value('产品资料.客户RMB单价', row) + recordset.value('产品资料.佣金单价', row) + recordset.value('产品资料.暗佣单价', row) + 0.0000001) * 10000) / 10000, row);
                recordset.val('产品资料.佣    金', recordset.value('产品资料.佣金单价', row) * recordset.value('产品资料.合同数量', row), row);
                recordset.val('产品资料.暗佣佣金', recordset.value('产品资料.暗佣单价', row) * recordset.value('产品资料.合同数量', row), row);
            };
            if (recordset.value('RMB客户') != '是') {
            ...
            if (recordset.value('RMB客户') != '是') {
                if (recordset.value('佣金类型').indexOf('明佣') != -1) {
                    if (recordset.value('产品资料.佣金比率', row) > 0) {
                        recordset.val('产品资料.佣金单价', Math.floor((recordset.value('产品资料.含佣单价', row) - recordset.value('产品资料.含佣单价', row) * (1 - recordset.value('产品资料.佣金比率', row))) * 10000) / 10000, row);
                    } else {
                        if (recordset.value('佣金类型') == '明佣') {
                            recordset.val('产品资料.佣金单价', Math.floor((recordset.value('产品资料.含佣单价', row) - recordset.value('产品资料.外销单价', row) + 0.00000001) * 10000) / 10000, row);
                        };
                    };
                    recordset.val('产品资料.佣    金', recordset.value('产品资料.佣金单价', row) * recordset.value('产品资料.合同数量', row), row);
                };
                if (recordset.value('佣金类型').indexOf('暗佣') != -1) {
                    if (recordset.value('产品资料.暗佣比率', row) > 0) {
                        recordset.val('产品资料.暗佣单价', Math.floor((recordset.value('产品资料.含佣单价', row) - recordset.value('产品资料.含佣单价', row) * (1 - recordset.value('产品资料.暗佣比率', row))) * 10000) / 10000, row);
                    } else {
                        if (recordset.value('佣金类型') == '暗佣') {
                            recordset.val('产品资料.暗佣单价', Math.floor((recordset.value('产品资料.含佣单价', row) - recordset.value('产品资料.外销单价', row) + 0.00000001) * 10000) / 10000, row);
                        };
                    };
                    recordset.val('产品资料.暗佣佣金', recordset.value('产品资料.暗佣单价', row) * recordset.value('产品资料.合同数量', row), row);
                };
                ...
                if (recordset.value('佣金类型').indexOf('明佣') != -1) {
                    if (recordset.value('产品资料.佣金比率', row) > 0) {
                        recordset.val('产品资料.佣金单价', Math.floor((recordset.value('产品资料.含佣RMB单价', row) - recordset.value('产品资料.含佣RMB单价', row) * (1 - recordset.value('产品资料.佣金比率', row))) * 10000) / 10000, row);
                    } else {
                        if (recordset.value('佣金类型') == '明佣') {
                            recordset.val('产品资料.佣金单价', Math.floor((recordset.value('产品资料.含佣RMB单价', row) - recordset.value('产品资料.客户RMB单价', row) + 0.00000001) * 10000) / 10000, row);
                        };
                    };
                    recordset.val('产品资料.佣    金', recordset.value('产品资料.佣金单价', row) * recordset.value('产品资料.合同数量', row), row);
                };
                if (recordset.value('佣金类型').indexOf('暗佣') != -1) {
                    if (recordset.value('产品资料.暗佣比率', row) > 0) {
                        recordset.val('产品资料.暗佣单价', Math.floor((recordset.value('产品资料.含佣RMB单价', row) - recordset.value('产品资料.含佣RMB单价', row) * (1 - recordset.value('产品资料.暗佣比率', row))) * 10000) / 10000, row);
                    } else {
                        if (recordset.value('佣金类型') == '暗佣') {
                            recordset.val('产品资料.暗佣单价', Math.floor((recordset.value('产品资料.含佣RMB单价', row) - recordset.value('产品资料.客户RMB单价', row) + 0.00000001) * 10000) / 10000, row);
                        };
                    };
                    recordset.val('产品资料.暗佣佣金', recordset.value('产品资料.暗佣单价', row) * recordset.value('产品资料.合同数量', row), row);
                };
            ...
            if (recordset.val('佣金类型') == '无') {
                ...
                if (recordset.value('RMB客户') != '是') {
                    if (recordset.value('产品资料.含佣单价', row) != recordset.value('产品资料.外销单价', row)) {
                        if (recordset.value('佣金类型') == '明佣') {
                            recordset.val('产品资料.佣金单价', Math.floor((recordset.value('产品资料.含佣单价', row) - recordset.value('产品资料.外销单价', row) + 0.0000001) * 10000) / 10000, row);
                            recordset.val('产品资料.暗佣单价', 0, row);
                            recordset.val('产品资料.暗佣佣金', 0, row);
                            recordset.val('产品资料.佣    金', recordset.value('产品资料.佣金单价', row) * recordset.value('产品资料.合同数量', row), row);
                        } else {
                            if (recordset.value('佣金类型') == '暗佣') {
                                recordset.val('产品资料.暗佣单价', Math.floor((recordset.value('产品资料.含佣单价', row) - recordset.value('产品资料.外销单价', row) + 0.0000001) * 10000) / 10000, row);
                                recordset.val('产品资料.佣金单价', 0, row);
                                recordset.val('产品资料.佣    金', 0, row);
                                recordset.val('产品资料.暗佣佣金', recordset.value('产品资料.暗佣单价', row) * recordset.value('产品资料.合同数量', row), row);
                            };
                    ...
                    if (recordset.value('产品资料.含佣RMB单价', row) != recordset.value('产品资料.客户RMB单价', row)) {
                        if (recordset.value('佣金类型') == '明佣') {
                            recordset.val('产品资料.佣金单价', Math.floor((recordset.value('产品资料.含佣RMB单价', row) - recordset.value('产品资料.客户RMB单价', row) + 0.0000001) * 10000) / 10000, row);
                            recordset.val('产品资料.暗佣单价', 0, row);
                            recordset.val('产品资料.暗佣佣金', 0, row);
                            recordset.val('产品资料.佣    金', recordset.value('产品资料.佣金单价', row) * recordset.value('产品资料.合同数量', row), row);
                        } else {
                            if (recordset.value('佣金类型') == '暗佣') {
                                recordset.val('产品资料.暗佣单价', Math.floor((recordset.value('产品资料.含佣RMB单价', row) - recordset.value('产品资料.客户RMB单价', row) + 0.0000001) * 10000) / 10000, row);
                                recordset.val('产品资料.佣金单价', 0, row);
                                recordset.val('产品资料.佣    金', 0, row);
                                recordset.val('产品资料.暗佣佣金', recordset.value('产品资料.暗佣单价', row) * recordset.value('产品资料.合同数量', row), row);
                            };
    ...
    if (field.full_name == n + '.产品资料.业务人员') {
        ...
        console.log('业务人员变更触发');
        if (ywry != '' && spsq == '' && (recordset.value('业务人员', row) == _.user.username || spsq == _.user.username)) {
            ...
            _.http.post("/api/saier/salesorder/item/hlb/set", {
                ...
                if (recordset.val('RMB客户') != '是') {
                    ...
                    if (recordset.value('产品资料.总 金 额', row) > 0 && recordset.value('产品资料.采购总额', row) > 0) {
                        ...
                        if (recordset.value('产品资料.单证锁定', row).trim() == '') {
                            ...
                            if ((recordset.value('产品资料.含佣单价', row) != recordset.value('产品资料.赔款单价1', row)) || (recordset.value('产品资料.外销单价', row) != recordset.value('产品资料.外销单价1', row)) || (recordset.value('产品资料.采购单价', row) != recordset.value('产品资料.采购单价1', row))) {
                                _.ui.message.error('不好意思,这个货号已经由单证:' + recordset.value('产品资料.单证锁定', row) + '锁定，请联系相关单证人员解锁');
                                recordset.val('产品资料.外销单价', recordset.value('产品资料.外销单价1', row));
                                recordset.val('产品资料.含佣单价', recordset.value('产品资料.赔款单价1', row));
                                recordset.val('产品资料.采购单价', recordset.value('产品资料.采购单价1', row));
                    ...
                    if (recordset.value('产品资料.客户RMB总价', row) > 0 && recordset.value('产品资料.采购总额', row) > 0) {
                        if (recordset.value('产品资料.单证锁定', row) == '') {
                            // let hl = 1;
                            let fyl = recordset.value('费 用 率', row);
...
function sales_order_table_new_after(evt_id, table, recordset) {
    if (table.group == '产品资料') {
        ...
        recordset.val('产品资料.外销唯一字段', recordset.val('rid'));
        recordset.val('产品资料.统计条件', recordset.val('rid'));
        if (recordset.val('强制更新') != '杂货') {
