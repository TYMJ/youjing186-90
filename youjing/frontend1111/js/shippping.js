...
const shipping_field_change = (evt_id, opts) => {
    ...
    if (field.full_name == m + '.是否新客' || field.full_name == '新客时间') {
        if (recordset.val('是否新客') == '是' && (recordset.val('新客时间') == '' || recordset.val('新客时间') == null)) {
    ...
    if (field.full_name == m + '.出运单号' && value != '') {
        ...
        if (lastChar >= 'A' && lastChar <= 'S') {
            ...
            if (recordset.val('出运单号') != recordset.val('外销发票')) recordset.val('外销发票', value)
        }
        _.http.post('/api/saier/shipping/cydh/change', {
    ...
    if (field.full_name == m + '.风控确认' && value != '待审批') {
        if (recordset.val('是否新客') == '新客新出' || recordset.val('是否新客') == '老客新出') {
    ...
    if (field.full_name == m + '.产品资料.出货箱数') {
        if (recordset.value('产品资料.是否拼箱', row) != '是' && recordset.value('产品资料.出货箱数', row) > 0 && recordset.value('产品资料.外箱容量', row) > 0) {
            if (recordset.value('产品资料.外箱容量', row) * recordset.value('产品资料.出货箱数', row) !== recordset.value('产品资料.出货数量', row)) {
                recordset.val('产品资料.出货数量', recordset.value('产品资料.外箱容量', row) * recordset.value('产品资料.出货箱数', row), row);
            }
        }
    }
    ...
    if (field.full_name == m + '.产品资料.客户货号' || field.full_name == m + '.产品资料.专业货号') {
    ...
    if (field.full_name == m + '.产品资料.毛    重' || field.full_name == m + '.产品资料.出货箱数') {
        if (recordset.value('产品资料.是否拼箱', row) != '是') {
            if (recordset.value('产品资料.毛    重', row) > 0 && recordset.value('产品资料.出货箱数', row) > 0) {
                recordset.val('产品资料.总 毛 重', ((recordset.value('产品资料.出货箱数', row) * recordset.value('产品资料.毛    重', row) / 1000)), row);
            } else {
    ...
    if (field.full_name == m + '.产品资料.净    重' || field.full_name == m + '.产品资料.出货箱数') {
        if (recordset.value('产品资料.是否拼箱', row) != '是') {
            if (recordset.value('产品资料.净    重', row) > 0 && recordset.value('产品资料.出货箱数', row) > 0) {
                recordset.val('产品资料.总 净 重', ((recordset.value('产品资料.出货箱数', row) * recordset.value('产品资料.净    重', row) / 1000)), row);
    ...
    if (field.full_name == m + '.产品资料.采购总价') {
        ...
        if (zzsl !== 0 && recordset.value('产品资料.退 税 率', row) !== 0) {
            if (recordset.value('产品资料.退 税 率', row) == 1) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / 1.01 * 0.01, 2), row)
            }
            if (recordset.value('产品资料.退 税 率', row) == 0) {
                recordset.val('产品资料.退税金额', 0, row)
            };
            if (recordset.value('产品资料.退 税 率', row) == 6) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / zzsl1 * 0.06, 2), row)
            }
            if (recordset.value('产品资料.退 税 率', row) == 4) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / 1.04 * 0.04, 2), row)
            }
            if (recordset.value('产品资料.退 税 率', row) == 13) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / zzsl1 * 0.13, 2), row)
            }
            if (recordset.value('产品资料.退 税 率', row) == 11) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / zzsl1 * 0.11, 2), row)
            }
            if (recordset.value('产品资料.退 税 率', row) == 9) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / zzsl1 * 0.09, 2), row)
            }
            if (recordset.value('产品资料.退 税 率', row) == 14) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / zzsl1 * 0.14, 2), row)
            }
            if (recordset.value('产品资料.退 税 率', row) == 5) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / zzsl1 * 0.05, 2), row)
            }
            if (recordset.value('产品资料.退 税 率', row) == 3) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / 1.03 * 0.03, 2), row)
            }
            if (recordset.value('产品资料.退 税 率', row) == 8) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / zzsl1 * 0.08, 2), row)
            }
            if (recordset.value('产品资料.退 税 率', row) == 15) {
                recordset.val('产品资料.退税金额', round(recordset.value('产品资料.采购总价', row) / zzsl1 * 0.15, 2), row)
            }
        } else {
            recordset.val('产品资料.退税金额', '0', row);
        }
    }
    if (field.full_name == m + '.产品资料.店铺名称' || field.full_name == m + '.产品资料.爱马士国家') {
        if (recordset.value('产品资料.店铺名称', row) == '' || recordset.value('产品资料.爱马士国家', row) == '') {
    ...
    if (field.full_name == m + '.产品资料.货 源 地') {
        if (recordset.value('产品资料.货 源 地', row) != '' && (recordset.value('产品资料.货 源 地', row).indexOf('其他') != -1 || recordset.value('产品资料.货 源 地', row).indexOf('其它') != -1)) {
            _.ui.message.error('请注意货源地中不能包含其他或其它');
            recordset.val('产品资料.货 源 地', '', row)
        }
    }
    if (field.full_name == m + '.产品资料.出货数量') {
        if (recordset.value('产品资料.出货数量', row) == 0 && recordset.value('产品资料.专业货号', row) != '') {
            recordset.val('产品资料.出货识别', '无', row)
        } else {
            recordset.val('产品资料.出货识别', '有', row)
        }
    }
    if ((field.full_name == m + '.产品资料.采购人员' || field.full_name == m + '.产品资料.业务人员') && value != '') {
        _.http.post('/api/saier/shipping/user/change', {
            username: value
        }).then(res => {
            let d = res.data;
    ...
    if (field.full_name == m + '.产品资料.专业货号') {
        if (value != '' && value != null) {
            _.http.post('/api/saier/shipping/zyhh/change', {
                cpbh: value
            }).then(res => {
                let d = res.data;
                if (d) {
    ...
    if (field.full_name == m + '.产品资料.采购合同') {
        if (value != '' && value != null) {
            _.http.post('/api/saier/shipping/cght/change', {
                hthm: value
            }).then(res => {
                let d = res.data;
    ...
    if (field.full_name == m + '.产品资料.海关编码') {
        if (value != '' && value != null) {
            _.http.post('/api/saier/shipping/hgbm/change', {
                hgbm: value
            }).then(res => {
                let d = res.data;
    ...
    let fields = [m + '.产品资料.佣金比率', m + '.产品资料.佣金单价', m + '.产品资料.外销总价', m + '.产品资料.客户RMB总价', m + '.产品资料.暗佣比率', m + '.产品资料.暗佣单价'];
    if (fields.indexOf(field.full_name) !== -1) {
        if (value != '' && value != null) {
            _.http.post('/api/saier/shipping/yjbl/change', {
                khmc: recordset.val('客户名称')
            }).then(res => {
                let d = res.data;
                if (recordset.val('RMB客户') != '是') {
                    if (recordset.value('产品资料.暗佣比率', row) > 0 && d != 1) {
                        recordset.val('产品资料.暗佣佣金', Math.floor((recordset.value('产品资料.暗佣比率', row) * recordset.value('产品资料.外销总价', row)) * 1000) / 1000, row);
                    } else {
                        if (recordset.value('产品资料.暗佣单价', row) > 0) {
                            recordset.val('产品资料.暗佣佣金', Math.floor((recordset.value('产品资料.暗佣单价', row) * recordset.value('产品资料.出货数量', row)) * 1000) / 1000, row);
                        } else {
                            recordset.val('产品资料.暗佣佣金', 0, row);
                        }
                    }
                    if (recordset.value('产品资料.佣金比率', row) > 0 && d != 1) {
                        recordset.val('产品资料.佣    金', Math.floor((recordset.value('产品资料.佣金比率', row) * recordset.value('产品资料.外销总价', row)) * 1000) / 1000, row);
                    } else {
                        if (recordset.value('产品资料.佣金单价', row) > 0) {
                            recordset.val('产品资料.佣    金', Math.floor((recordset.value('产品资料.佣金单价', row) * recordset.value('产品资料.出货数量', row)) * 1000) / 1000, row);
                        } else {
                    ...
                    if (recordset.value('产品资料.暗佣比率', row) > 0 && d != 1) {
                        recordset.val('产品资料.暗佣佣金', Math.floor((recordset.value('产品资料.暗佣比率', row) * recordset.value('产品资料.客户RMB总价', row)) * 1000) / 1000, row);
                    } else {
                        if (recordset.value('产品资料.暗佣单价', row) > 0) {
                            recordset.val('产品资料.暗佣佣金', Math.floor((recordset.value('产品资料.暗佣单价', row) * recordset.value('产品资料.出货数量', row)) * 1000) / 1000, row);
                        } else {
                    ...
                    if (recordset.value('产品资料.佣金比率', row) > 0 && d != 1) {
                        recordset.val('产品资料.佣    金', Math.floor((recordset.value('产品资料.佣金比率', row) * recordset.value('产品资料.客户RMB总价', row)) * 1000) / 1000, row);
                    } else {
                        if (recordset.value('产品资料.佣金单价', row) > 0) {
                            recordset.val('产品资料.佣    金', Math.floor((recordset.value('产品资料.佣金单价', row) * recordset.value('产品资料.出货数量', row)) * 1000) / 1000, row);
                        } else {
    ...
    if (field.full_name == m + '.产品资料.赠送' && value != '') {
        if (recordset.value('产品资料.赠送', row) == '是' || recordset.value('产品资料.赠送', row) == '工厂' || recordset.value('产品资料.赠送', row) == '客人') {
            if (recordset.value('单证确认', row) == '再审') {
                recordset.val('产品资料.是否改单', '是', row);
            }
            recordset.val('产品资料.外销唯一字段2', recordset.value('产品资料.外销唯一字段', row), row);
            recordset.val('产品资料.唯一字段2', recordset.value('产品资料.唯一字段', row), row);
            if (recordset.value('产品资料.赠送', row) == '是' || recordset.value('产品资料.赠送', row) == '工厂') {
                recordset.val('产品资料.唯一字段', '', row);
                recordset.val('产品资料.采购合同', recordset.value('产品资料.采购合同', row) + '赠送', row);
                recordset.val('产品资料.采购单价', 0, row);
            }
            if (recordset.value('产品资料.赠送', row) == '是' || recordset.value('产品资料.赠送', row) == '客人') {
                recordset.val('产品资料.外销唯一字段', '', row);
                recordset.val('产品资料.外销合同', recordset.value('产品资料.外销合同', row) + '赠送', row);
            ...
            _.ui.show_input_select_dialog('请输确认是否报关:', '否', ['否', '是']).then(val => {
                if (val == '否') {
            ...
            if (recordset.value('产品资料.赠送', row) == '单报关') {
                recordset.module.field_by_full_name(m + '.产品资料.采购单价').disabled = false;
                recordset.module.field_by_full_name(m + '.产品资料.赔款单价').disabled = false;
                recordset.module.field_by_full_name(m + '.产品资料.赔款RMB').disabled = false;
                recordset.module.field_by_full_name(m + '.产品资料.客户RMB单价').disabled = false;
            } else if (recordset.value('产品资料.赠送', row) == '否') {
                if (recordset.value('单证确认') == '再审') {
                    recordset.val('产品资料.是否改单', '是', row);
                }
                if (recordset.value('产品资料.外销唯一字段2', row) != '') {
                    recordset.val('产品资料.外销唯一字段', recordset.value('产品资料.外销唯一字段2', row), row);
                }
                if (recordset.value('产品资料.唯一字段2', row) != '') {
                    recordset.val('产品资料.唯一字段', recordset.value('产品资料.唯一字段2', row), row);
                }
                recordset.module.field_by_full_name(m + '.产品资料.采购单价').disabled = true;
                recordset.module.field_by_full_name(m + '.产品资料.采购总价').disabled = true;
                recordset.module.field_by_full_name(m + '.产品资料.外销总价').disabled = true;;
                recordset.module.field_by_full_name(m + '.产品资料.客户RMB总价').disabled = true;
                ...
                _.http.post('/api/saier/shipping/zs/change', {
    ...
    if (field.full_name == m + '.产品资料.出货数量') {
        if (value > 0) {
            if (recordset.value('产品资料.出运唯一字段', row) == '') {
                recordset.val('产品资料.出运唯一字段', recordset.value('产品资料.rid', row), row);
            }
            _.http.post('/api/saier/shipping/chsl/change', {
                ...
                if (cgsl - jhhj >= 0 && recordset.value('产品资料.出货数量', row) > 0) {
                ...
                if (recordset.value('产品资料.是否拼箱', row) != '是') {
                    if (recordset.value('产品资料.出货数量', row) > 0 && recordset.value('产品资料.外箱容量', row) > 0) {
                        recordset.val('产品资料.出货箱数', Math.trunc(recordset.value('产品资料.出货数量', row) / recordset.value('产品资料.外箱容量', row)), row);
                    } else {
                ...
                if (recordset.value('产品资料.出货数量', row) > 0 && recordset.value('产品资料.合同数量', row) == 0 && recordset.value('产品资料.采购数量', row) == 0) {
                    recordset.val('产品资料.合同数量', recordset.value('产品资料.出货数量', row), row);
                    recordset.val('产品资料.采购数量', recordset.value('产品资料.出货数量', row), row);
                    if (recordset.value('产品资料.外箱容量', row) > 1 && (recordset.value('产品资料.箱    数', row) == 0)) {
                        recordset.val('产品资料.箱    数', recordset.value('产品资料.合同数量', row) / recordset.value('产品资料.外箱容量', row), row);
                    }
                }
            }).catch(err => {
                _.ui.message.error(err.msg);
    ...
    if (field.full_name == m + '.产品资料.唯一字段' && value != '') {
        ...
        _.http.post('/api/saier/shipping/wyzd/change', {
            hthm: recordset.value('产品资料.采购合同', row),
            // cpbh: recordset.value('产品资料.专业货号', row),
            wyzd: recordset.value('产品资料.唯一字段', row),
            cywyzd: recordset.value('产品资料.出运唯一字段', row)
            ...
            if (cgsl - jhsl - yjhs >= 0 && recordset.value('产品资料.出货数量', row) > 0) {
    ...
    if (field.full_name == m + '.产品资料.替换合同') {
        _.http.post('/api/saier/shipping/thht/change', {
    ...
    fields = [m + '.补报信息.发票号码', m + '.补报信息.产品编号', m + '.补报信息.采购合同', m + '.补报信息.出运唯一字段', m + '.补报信息.外销唯一字段'];
    if (fields.indexOf(field.full_name) !== -1) {
        _.http.post('/api/saier/shipping/bbxx/change', {
    ...
    if (field.full_name == m + '.目的口岸' && value != '') {
        if (!(recordset.val('客户名称').toUpperCase().indexOf('AMAZON') != -1 || recordset.val('外销发票').toUpperCase().indexOf('AMZ') != -1)) {
            _.http.post('/api/saier/shipping/mdka/change', {
    ...
    if (field.full_name == m + '.已收定金' && value > 0.1) {
        ...
        _.http.post('/api/saier/shipping/ysdj/change', {
    ...
    if (field.full_name == m + '.LC信保') {
        _.http.post('/api/saier/shipping/lcxb/change', {
            khmc: recordset.val('客户名称'),
    ...
    if (field.full_name == m + '.是否信保') {
        _.http.post('/api/saier/shipping/sfxb/change', {
            khmc: recordset.val('客户名称'),
    ...
    if (field.full_name == m + '.合同号码' && value != '') {
        _.http.post('/api/saier/shipping/wxht/change', {
    ...
    if (field.full_name == m + '.外销发票' && value != '') {
        if (recordset.val('外销发票') != '' && recordset.val('外销发票') != recordset.val('出运单号')) {
            recordset.val('出运单号', recordset.val('外销发票'));
        }
        _.http.post('/api/saier/shipping/wxfp/change', {
            fphm: recordset.val('外销发票')
        }).then(res => {
            let d = res.data;
            if (d) {
                if (recordset.val('外销发票') != '' && recordset.val('外销发票') == recordset.val('出运单号')) {
                    ...
                    if ((recordset.val('装柜日期') == '' || recordset.val('装柜日期') == null) && d.StuffingDate) {
    ...
    if (field.full_name == m + '.品 名 数') {
        if (value >= 1) {
            _.http.post('/api/saier/shipping/pms/change', {
    ...
    if (field.full_name == m + '.定金查看') {
        if (value == '是') {
            ...
            _.http.post('/api/saier/shipping/djck/change', {
                rid: recordset.val('rid'),
                ht_list: ht_list
            }).then(res => {
                let d = res.data;
    ...
    if (field.full_name == m + '.客户名称' && value != '') {
        _.http.post('/api/saier/shipping/khmc/change', {
            ...
            if (recordset.val('风控管理') == '是' || recordset.val('客户名称').indexOf('AMAZON') != -1) {
    ...
    if (field.full_name == m + '.风控人员' && value != '') {
        if (recordset.val('客户名称').indexOf('AMAZON') == -1) {
            _.http.post('/api/saier/shipping/fkry/change', {
    ...
    if (field.full_name == m + '.单证人员' && value != '') {
        if (recordset.val('客户名称').indexOf('AMAZON') == -1) {
            _.http.post('/api/saier/shipping/dzry/change', {
    ...
    if (field.full_name == m + '.数值') {
        if (recordset.val('风控人员') == username || recordset.val('风控审单') == username) {
            _.http.post('/api/saier/shipping/sz/change', {}).then(res => {
                let ds = 7.1
                let xs = 5
                let d = res.data;
                if (d) {
                ...
                for (let r of lines) {
                    ...
                    if (csz > 0 && wxzj > 0) {
                        ...
                        if (hhcb1 > ds || hhcb1 < xs) {
                            if (dhhcb == '') {
                                dhhcb = '第' + i + '条记录换汇成本' + hhcb1 + '大于' + ds + '或小于' + xs;
                            } else {
                                dhhcb = dhhcb + "\n" + '第' + i + '条记录换汇成本' + hhcb1 + '大于' + ds + '或小于' + xs;
                            }
                        }
                    }
                }
    ...
    if (field.full_name == m + '.出运申请' && value != '') {
        ...
        if (recordset.val('货柜类型') != 'LCL' && recordset.val('小柜数量') == 0 && recordset.val('平柜数量') == 0 && recordset.val('高柜数量') == 0 && recordset.val('出运申请') != '') {
            _.ui.message.error('不好意思,柜型不为LCL的情况下必需要填写小柜、平柜或高柜的数量')
            recordset.val('出运核准', '待审批')
            recordset.val('出运申请', '')
        }
        if ((recordset.val('外销发票') != recordset.val('出运单号') || recordset.val('外销发票') == '') && recordset.val('出运申请') != '') {
            _.ui.message.error('不好意思,出运单号和外销发票不一致或为空')
            recordset.val('出运核准', '待审批')
            recordset.val('出运申请', '')
        }
        if ((recordset.val('货代资料') == '' || recordset.val('我方抬头') == '' || recordset.val('收 货 人') == '' || recordset.val('抬 头 人') == '' ||
                recordset.val('通 知 人') == '' || (recordset.val('唛    头') == '' && recordset.val('运输方式') != 'by post')) && recordset.val('出运申请') != '') {
            _.ui.message.error('不好意思,货代资料、唛    头、通 知 人、抬 头 人、收 货 人、我方抬头不能为空')
            recordset.val('出运核准', '待审批')
            recordset.val('出运申请', '')
        }
        if (recordset.val('出运申请') == username && recordset.val('出运申请') != '') {
        ...
        if (cysq != '') {
            _.http.post('/api/saier/shipping/cysq/change', {
                ...
                if (bgdsc == '待上传') {
                    _.ui.message.error('该票需向工厂拿回报关单复印件，且要签订委托报关协议，出货后7天内请在出运计划界面上传附件')
                }
                if (recordset.val('出运申请') != '') recordset.module.field_by_full_name(m + '.出运申请').disabled = true
            }).catch(err => {
                let d = err.data
                if (d) {
                    let error1 = d.error1
...
_.evts.on([_.evtids.RECORD_TABLE_AFTER_NEW, _.evtids.RECORD_TABLE_AFTER_COPY], shipping_table_new_after, '出运计划')
...
_.evts.on([_.evtids.MODULE_EDITOR_GROUP_SHOW], shipping_EditorChildShow, '出运计划')
...
const shipping_form_BtnClick = (evt_id, btn, form) => {
    ...
    if (btn.name == 'supplier_update_btn') {
        let t = recordset.tables['产品资料']
        let lines = t.view_data
        _.http.post('/api/saier/shipping/items/update/supplier', {
            lines: lines,
        }).then(res => {
            let d = res.data;
            for (let r of lines) {
                if (r.sccj1id == null || r.sccj1id == '') {
                    continue
                }
                if (r.zhwbgpm == null || r.zhwbgpm == '' || r.skfm == null || r.skfm == '' || r.bank == null || r.bank == '' || r.zh == null || r.zh == '') {
                    if (r.sccj1id in d) {
                        let l = d[r.sccj1id];
                        r.zhwbgpm = l.zhwbgpm;
                        r.skfm = l.fkhm;
    ...
    if (btn.name == 'hyd_update_btn') {
        let t = recordset.tables['产品资料']
        let lines = t.view_data
        _.http.post('/api/saier/shipping/items/update/hyd', {
            lines: lines,
        }).then(res => {
            let d = res.data;
            for (let r of lines) {
    ...
    if (btn.name == 'dzzt_update_btn') {
        ...
        _.http.post('/api/saier/shipping/update/dzzt', {}).then(res => {
            let d = res.data;
            if (d && d != '' && d != null) {
    ...
    if (btn.name == 'dgmb_download_btn') {
        ...
        _.http.post('/api/saier/shipping/download/dgmb', {
            rids: rids,
        }).then(res => {
            let d = res.data;
    ...
    if (btn.name == 'fkkh_open_btn') {
        ...
        _.http.post('/api/saier/shipping/open/fkkh', {
            lines: lines,
        }).then(res => {
            let d = res.data;
            if (d && d != '' && d != null) {
    ...
    if (btn.name == 'item_all_update_btn' || btn.name == 'item_row_update_btn') {
        ...
        _.http.post('/api/saier/shipping/items/update/data', {
            lines: lines,
        }).then(res => {
            let d = res.data;
            for (let r of lines) {
                ...
                if (rid in d) {
                    let l = d[rid];
                    r[recordset.module.field_by_full_name(m + '.产品资料.货币代码').db.name] = l.hbdm
                    r[recordset.module.field_by_full_name(m + '.产品资料.报关单位').db.name] = l.bgjldw
                    r[recordset.module.field_by_full_name(m + '.产品资料.中文报关品名').db.name] = l.zhwbgpm
                    r[recordset.module.field_by_full_name(m + '.产品资料.增值税率').db.name] = l.zzsl
                    r[recordset.module.field_by_full_name(m + '.产品资料.退 税 率').db.name] = l.sl
                    r[recordset.module.field_by_full_name(m + '.产品资料.备    注').db.name] = l.bz3
                    r[recordset.module.field_by_full_name(m + '.产品资料.交货日期').db.name] = l.jhrq
                    r[recordset.module.field_by_full_name(m + '.产品资料.客户货号').db.name] = l.khhh
                    r[recordset.module.field_by_full_name(m + '.产品资料.海关编码').db.name] = l.hgbm
                    r[recordset.module.field_by_full_name(m + '.产品资料.完成数量').db.name] = l.wcsl
                    r[recordset.module.field_by_full_name(m + '.产品资料.毛    重').db.name] = l.mz
                    r[recordset.module.field_by_full_name(m + '.产品资料.付款抬头').db.name] = l.fktt
                    r[recordset.module.field_by_full_name(m + '.产品资料.净    重').db.name] = l.jz
                    r[recordset.module.field_by_full_name(m + '.产品资料.包装长度').db.name] = l.bzcd
                    r[recordset.module.field_by_full_name(m + '.产品资料.包装宽度').db.name] = l.bzkd
                    r[recordset.module.field_by_full_name(m + '.产品资料.货 源 地').db.name] = l.hyd
                    r[recordset.module.field_by_full_name(m + '.产品资料.包装高度').db.name] = l.bzgd
                    r[recordset.module.field_by_full_name(m + '.产品资料.外箱体积').db.name] = l.tj
                    r[recordset.module.field_by_full_name(m + '.产品资料.纸卡费用').db.name] = l.zkfy
                    r[recordset.module.field_by_full_name(m + '.产品资料.是否商检').db.name] = l.sjqk
                    r[recordset.module.field_by_full_name(m + '.产品资料.开票工厂').db.name] = l.kpgc
                    r[recordset.module.field_by_full_name(m + '.产品资料.专业厂家').db.name] = l.sccj1
                    r[recordset.module.field_by_full_name(m + '.产品资料.工厂名称').db.name] = l.csmc
                    r[recordset.module.field_by_full_name(m + '.产品资料.组织机构代码').db.name] = l.zzjgdm
                    r[recordset.module.field_by_full_name(m + '.产品资料.开票联系人').db.name] = l.kplxr
                    r[recordset.module.field_by_full_name(m + '.产品资料.开票电话').db.name] = l.kpdh
                    r[recordset.module.field_by_full_name(m + '.产品资料.进仓时间').db.name] = l.jcsj
                    r[recordset.module.field_by_full_name(m + '.产品资料.其它说明').db.name] = l.qtsm1
                    r[recordset.module.field_by_full_name(m + '.产品资料.预计船期').db.name] = l.yjcq
                    r[recordset.module.field_by_full_name(m + '.产品资料.专业产品编号').db.name] = l.zycpbh
                    r[recordset.module.field_by_full_name(m + '.产品资料.采购人员').db.name] = l.cgry
                    r[recordset.module.field_by_full_name(m + '.产品资料.跟单人员').db.name] = l.gdry
                    r[recordset.module.field_by_full_name(m + '.产品资料.开票点数').db.name] = l.ljrk
                    r[recordset.module.field_by_full_name(m + '.产品资料.采购单价').db.name] = l.cgjg
                    r[recordset.module.field_by_full_name(m + '.产品资料.采购数量').db.name] = l.cgsl
                    r[recordset.module.field_by_full_name(m + '.产品资料.合同数量').db.name] = l.cgsl
                    r[recordset.module.field_by_full_name(m + '.产品资料.箱    数').db.name] = Math.trunc(l.cgxs)
                    r[recordset.module.field_by_full_name(m + '.产品资料.可思达货号').db.name] = l.ksdhh

                    r[recordset.module.field_by_full_name(m + '.产品资料.外销单价').db.name] = l.wxdj
                    r[recordset.module.field_by_full_name(m + '.产品资料.赔款单价').db.name] = l.Twxdj
                    r[recordset.module.field_by_full_name(m + '.产品资料.客户RMB单价').db.name] = l.mjdj1
                    r[recordset.module.field_by_full_name(m + '.产品资料.赔款RMB').db.name] = l.pkRMB
                    r[recordset.module.field_by_full_name(m + '.产品资料.客户货号').db.name] = l.khhh
                    r[recordset.module.field_by_full_name(m + '.产品资料.暗佣比率').db.name] = l.aybl
                    r[recordset.module.field_by_full_name(m + '.产品资料.暗佣单价').db.name] = l.asl6
                    r[recordset.module.field_by_full_name(m + '.产品资料.佣金比率').db.name] = l.yjbl
                    r[recordset.module.field_by_full_name(m + '.产品资料.佣金单价').db.name] = l.sl6
                    r[recordset.module.field_by_full_name(m + '.产品资料.RMB客户').db.name] = l.khpd
                    r[recordset.module.field_by_full_name(m + '.产品资料.业务人员').db.name] = l.bjyw
                    r[recordset.module.field_by_full_name(m + '.产品资料.客人订单号').db.name] = l.krddh
                    r[recordset.module.field_by_full_name(m + '.产品资料.转美元汇率').db.name] = l.zmyhl
                    if (l.djpm != '' && l.djpm != null) {
                        r[recordset.module.field_by_full_name(m + '.产品资料.单据品名').db.name] = l.djpm
                    }
                    if (l.caizi != '' && l.caizi != null) {
                        r[recordset.module.field_by_full_name(m + '.产品资料.材质英文').db.name] = l.caizi
                    }
                    if (l.krtm != '' && l.krtm != null) {
                        r[recordset.module.field_by_full_name(m + '.产品资料.客人条码').db.name] = l.krtm
                    }
                    if (l.ywpm != '' && l.ywpm != null) {
                        r[recordset.module.field_by_full_name(m + '.产品资料.英文品名').db.name] = l.ywpm
                    }
                    r[recordset.module.field_by_full_name(m + '.产品资料.是否授权').db.name] = l.sfsq
                    if (l.wypp != '' && l.wypp != null) {
                        r[recordset.module.field_by_full_name(m + '.产品资料.外语品名').db.name] = l.wypp
                    }
                    if (l.krCODE != '' && l.krCODE != null) {
                        r[recordset.module.field_by_full_name(m + '.产品资料.客人CODE').db.name] = l.krCODE
                    }
                    if (l.djpmy != '' && l.djpmy != null) {
                        r[recordset.module.field_by_full_name(m + '.产品资料.单据品名英').db.name] = l.djpmy
                    }
                    if (l.djpmw != '' && l.djpmw != null) {
                        r[recordset.module.field_by_full_name(m + '.产品资料.单据品名外').db.name] = l.djpmw
                    }
                    if (l.wypp != '' && l.wypp != null) {
                        r[recordset.module.field_by_full_name(m + '.产品资料.外语品名').db.name] = l.wypp
                    }
    ...
    if (btn.name == 'fphm_update_btn') {
        if (recordset.val('出运申请') != '' || recordset.val('制单人员') != username) {
            _.ui.message.error('出运申请为空且由本人的记录才能更改发票号码')
            return
        }
        let t = recordset.tables['产品资料']
        let lines = t.view_data
        _.http.post('/api/saier/shipping/update/fphm', {
            lines: lines,
        }).then(res => {
            let d = res.data;
            for (let r of lines) {
    ...
    if (btn.name == 'gdsq_update_btn') {
        if (recordset.val('外销发票') == '' || recordset.val('出运申请') == '' || recordset.val('制单人员') != username) {
            _.ui.message.error('外销发票、出运申请不能为空且由本人的记录才能进行改单申请')
            return
        }
        _.ui.confirm('确认要提交改单申请吗？', '提示').then(() => {
            _.http.post('/api/saier/shipping/update/apply', {
                wxfp: recordset.val('外销发票'),
                spsq: recordset.val('出运申请'),
                rid: recordset.val('rid')
            }).then(res => {
    ...
    if (btn.name == 'dzry_update_btn') {
        _.http.post('/api/saier/shipping/check/dzry', {
    ...
    if (btn.name == 'cymx_new_btn') {
        _.http.post('/api/saier/shipping/new/shipment', {
            rid: form.current_rid.value,
        }).then(res => {
            let d = res.data
            _.ui.message.success(res.msg)
...
const shipping_before_save = (evt_id, recordset) => {
    return new Promise((resolve, reject) => {
        ...
        if (recordset.val('风控暂扣') == '是' && recordset.val('单证确认') == '结束') {
...
const shipping_recordLoad = (evt_id, recordset) => {
    _.http.post('/api/saier/shipping/load/check', {
        rid: recordset.val('rid'),
        fphm: recordset.val('外销发票'),
        khmc: recordset.val('客户名称'),
    }).then(function (res) {
        ...
        if (recordset.val('风控管理') == '是' || recordset.val('客户名称').toUpperCase().indexOf('AMAZON') != -1) {
            recordset.module.field_by_full_name(m + '.出运申请').disabled = false;
        } else {
            recordset.module.field_by_full_name(m + '.出运申请').disabled = true;
        }
        ...
        if ((recordset.val('出运申请') == '' || recordset.val('单证确认') == '再审') && recordset.val('制单人员') == username) {} else {
        ...
        if ((username == recordset.val('风控审单')) || (username == recordset.val('风控人员')) || (username == 'zjnblh') || (username == '赵波') || (username == '赵波U')) {
            ...
            if (recordset.val('商检提醒') == '是') {
                _.ui.message.error('该票含有需商检材质，请检查产品资料是否要商检\n可通过产品资料——商检提醒查看');
            }
        }
        if (recordset.val('单证人员') == username && ((recordset.val('风控确认') == '通过') || (recordset.val('客户名称').toUpperCase().indexOf('AMAZON') != -1)) && (recordset.val('出运核准') == '通过')) {} else {
            recordset.module.field_by_full_name(m + '.单证确认').disabled = true;
        }
        if (recordset.val('风控管理') == '是' || (recordset.val('客户名称').toUpperCase().indexOf('AMAZON') != -1)) {
        ...
        recordset.module.field_by_full_name(m + '.审单状态').view.can_modi_in_workflow = false;
        recordset.module.field_by_full_name(m + '.信保特定').view.can_modi_in_workflow = false;
        recordset.module.field_by_full_name(m + '.报关单上传').view.can_modi_in_workflow = false;
        recordset.module.field_by_full_name(m + '.审单说明').view.can_modi_in_workflow = false;
        ...
        if (username == recordset.val('风控审单') || username == recordset.val('风控人员') || username == recordset.val('风控单证') || username == recordset.val('出运申请') ||
            username == recordset.val('总监核准') || username == recordset.val('单证人员') || recordset.val('出运申请') != '') {
            recordset.module.field_by_full_name(m + '.出运申请').disabled = true;
            ...
            recordset.module.field_by_full_name(m + '.Insurance 是否做保险').disabled = true;
            ...
            if (username == recordset.val('风控审单') || username == recordset.val('风控人员') || username == recordset.val('风控单证') || username == recordset.val('单证人员')) {
            ...
            recordset.module.field_by_full_name(m + '.产品资料.外销合同').disabled = true;
            ...
            recordset.module.field_by_full_name(m + '.产品资料.英文报关品名').disabled = true;
            ...
            recordset.module.field_by_full_name(m + '.产品资料.剩余数量').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.报关单位').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.海关编码').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.退 税 率').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.出货箱数').disabled = true;
            ...
            recordset.module.field_by_full_name(m + '.产品资料.是否代开').disabled = true;
            ...
            recordset.module.field_by_full_name(m + '.产品资料.验货人员').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.纸卡费用').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.是否拼箱').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.客人CODE').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.是否商检').disabled = true;
            ...
            recordset.module.field_by_full_name(m + '.产品资料.RMB客户').disabled = true;
            ...
            recordset.module.field_by_full_name(m + '.产品资料.组织机构代码').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.开票联系人').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.开票电话').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.进仓时间').disabled = true;
            ...
            recordset.module.field_by_full_name(m + '.产品资料.材质英文').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.审单建议').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.先前出运数量').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.采购合同数').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.付款抬头').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.RMB客户').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.赠送').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.采购单价').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.采购总价').disabled = true;
            if (username == recordset.val('出运申请') && username !== recordset.val('制单人员')) {
            ...
            recordset.module.field_by_full_name(m + '.产品资料.赔款单价').disabled = true;
            recordset.module.field_by_full_name(m + '.产品资料.赔款RMB').disabled = true;
            if ((username == recordset.val('出运申请') || username == recordset.val('总监核准')) && recordset.val('风控人员') == '' && recordset.val('出运核准') == '通过') {
                if (recordset.val('客户名称').toUpperCase().indexOf('AMAZON') != -1) {} else {
                    recordset.module.field_by_full_name(m + '.风控人员').disabled = false;
                }
            }
            if (username == recordset.val('风控人员')) {
                ...
                if (recordset.val('单证确认') !== '结束') {
                    recordset.module.field_by_full_name(m + '.风控暂扣').disabled = false;
                }
                if (recordset.val('风控确认') !== '通过') {
                    recordset.module.field_by_full_name(m + '.风控确认').disabled = false;
                    recordset.module.field_by_full_name(m + '.是否新客').disabled = false;
                    recordset.module.field_by_full_name(m + '.新客时间').disabled = false;
                } else {
            ...
            if (username == recordset.val('风控审单')) {
                recordset.module.field_by_full_name(m + '.审单状态').view.can_modi_in_workflow = true;
                recordset.module.field_by_full_name(m + '.信保特定').view.can_modi_in_workflow = true;
                recordset.module.field_by_full_name(m + '.报关单上传').view.can_modi_in_workflow = true;
                recordset.module.field_by_full_name(m + '.审单说明').view.can_modi_in_workflow = true;
                ...
                recordset.module.field_by_full_name(m + '.产品资料.审单建议').disabled = false;
            }
            if (username == recordset.val('风控单证')) {
                if (recordset.val('单证状态') === '通过') {
                    recordset.module.field_by_full_name(m + '.单证人员').disabled = false;
                } else {
                    recordset.module.field_by_full_name(m + '.单证状态').disabled = false;
            ...
            if (username == recordset.val('单证人员')) {
                ...
                recordset.module.field_by_full_name(m + '.箱号明细').disabled = false;
                recordset.module.field_by_full_name(m + '.货柜数量').disabled = false;
                if ((recordset.val('风控确认') === '通过') || (recordset.val('客户名称').toUpperCase().indexOf('AMAZON') != -1)) {
                    recordset.module.field_by_full_name(m + '.单证确认').disabled = false;
                }
            }
        } else {
            ...
            if (sp !== '') {
                ...
                if ((sp === username) || (username === recordset.val('总监核准'))) {
                    if (recordset.val('出运核准') !== '通过') {
                        recordset.module.field_by_full_name(m + '.出运核准').disabled = false;
                    }
                    if (recordset.val('客户名称').toUpperCase().indexOf('AMAZON') != -1) {
                        recordset.module.field_by_full_name(m + '.出运核准').disabled = false;
                    }
        ...
        if (recordset.val('外销发票') != '') {
            ...
            recordset.module.field_by_full_name(m + '.外销发票').disabled = (d.cybz == 1);
        } else {
            recordset.module.field_by_full_name(m + '.已收定金').disabled = true;
        };
        recordset._list[m + '.出运申请'] = d.dl_list;
...
const shipping_after_save = (evt_id, recordset) => {
    if ((recordset.val('wf_status') == 0 || recordset.val('wf_status') == 3)) {
        ...
        let next_unit = ''
        let wf_status = 1
        if (recordset.val('uid') == _.user.rid && recordset.val('出运申请') != '' && current_unit == '业务人员'){
            next_unit = '出运申请'
        } else if ((recordset.val('出运申请') == _.user.username || recordset.val('总监核准') == _.user.username) && current_unit == '出运申请' && recordset.val('出运核准') != '待审批') {
            if (recordset.val('出运核准') != '通过') {
                next_unit = '业务人员'
                wf_status = 2
            } else {
        ...
        } else if (recordset.val('风控人员') == _.user.username && current_unit == '风控人员' && recordset.val('风控确认') != '待审批' && recordset.val('出运核准') == '通过') {
            if (recordset.val('风控确认') != '通过') {
                next_unit = '业务人员'
                wf_status = 2
            } else {
        ...
        //     next_unit = '风控单证'
        } else if (recordset.val('风控单证') == _.user.username && recordset.val('单证状态') != '待审批' && current_unit == '风控单证' && recordset.val('审单状态') == '结束') {
            if (recordset.val('单证状态') != '通过') {
                next_unit = '业务人员'
                wf_status = 2
            } else {
