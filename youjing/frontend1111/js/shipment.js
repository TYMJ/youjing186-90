...
const shipment_field_change = (evt_id, opts) => {
    ...
    if (
        ...
        if (
            ...
            (recordset.val('产品资料.是否拼箱') == '否' ||
                recordset.val('产品资料.是否拼箱') == '') &&
            recordset.val('产品资料.箱    数') > 0
        ) {
            recordset.val(
                '产品资料.出货数量',
                recordset.val('产品资料.箱    数') * recordset.val('产品资料.外箱容量'),
            )
        }
    }
    if (
        ...
        if (
            ...
            if (bztj != 0) {
                if (
                    ...
                    recordset.val('产品资料.外箱体积', bztj)
                } else {
                    recordset.val('产品资料.外箱体积', Math.round(bztj * 1000) / 1000)
    ...
    if (field.full_name == m + '.产品资料.出运唯一字段12' && value != '') {
        if (
            ...
            _.http
                .post('/api/saier/shipment/cywyzd12/change', {
                    cywyzd: value,
                })
                .then((res) => {
                    let d = res.data
                    if (d) {
                        ...
                        let khhh = d.khhh
                        if (khhh != '' && khhh != null) {
                            recordset.val('产品资料.产品编号', khhh)
                        } else {
                            recordset.val('产品资料.产品编号', zyhh)
                        }
                        recordset.val('产品资料.专业产品编号', zyhh)
                        recordset.val('产品资料.原产品编号', zyhh)
                    }
                })
                .catch((err) => {
                    _.ui.message.error(err.msg)
    ...
    if (fields.includes(field.full_name)) {
        let cywyzd = recordset.val('产品资料.出运唯一字段')
        if (
            recordset.val('强制更新') != '是' &&
            recordset.val('强制更新') != '是1' &&
            ...
            _.http
                ...
                .then((res) => {
                    let d = res.data
                    if (d == 0) {
                        if (recordset.val('产品资料.引用识别') == '是') {
                            recordset.val('产品资料.改价判断2', '是')
                            recordset.val('产品资料.web判断2', '是')
                        }
                    } else {
    ...
    if (field.full_name == m + '.产品资料.毛    重' && value != '') {
        if (recordset.val('强制更新') != '是') {
            let wxzmz =
                recordset.val('产品资料.毛    重') * recordset.val('产品资料.箱    数')
            recordset.val('产品资料.总 毛 重', Math.round(wxzmz * 10) / 10)
            if (recordset.val('产品资料.毛    重1') > 0) {
                if (recordset.val('自动净重') != '否') {
                    if (recordset.val('产品资料.毛    重') > 0) {
                        let yjz = recordset.val('产品资料.净    重1')
                        if (yjz == 0) {
                            yjz = recordset.val('产品资料.净    重')
                        }
                        let mz1 = recordset.val('产品资料.毛    重1')
                        if (mz1 == 0) {
                            mz1 = recordset.val('产品资料.毛    重')
                        }
                        let mz2 = recordset.val('产品资料.毛    重')
                        if (mz2 > mz1) {
                            let mz = mz2 - mz1
                            let xjz = yjz / mz1
                            let mz3 = Math.round(mz * xjz * 100) / 100
                            recordset.val('产品资料.净    重', yjz + mz3)
                            recordset.val('产品资料.净    重1', yjz + mz3)
                        } else if (mz2 < mz1) {
                            let mz = mz1 - mz2
                            let xjz = yjz / mz1
                            let mz3 = Math.round(mz * xjz * 100) / 100
                ...
                recordset.val('产品资料.毛    重1', recordset.val('产品资料.毛    重'))
            }
        }
    }
    if (field.full_name == m + '.产品资料.净    重' && value != '') {
        if (recordset.val('强制更新') != '是') {
            recordset.val('产品资料.净    重1', recordset.val('产品资料.净    重'))
        }
    }
    if (field.full_name == m + '.产品资料.赠送' && value != '') {
        if (
            ...
            (recordset.val('产品资料.赠送') == '是' ||
                ...
                recordset.val('产品资料.赠送') == '客人')
        ) {
            recordset.val(
                '产品资料.外销唯一字段2',
                recordset.val('产品资料.外销唯一字段'),
            )
            recordset.val('产品资料.唯一字段2', recordset.val('产品资料.唯一字段'))
            if (
                recordset.val('产品资料.赠送') == '是' ||
                recordset.val('产品资料.赠送') == '客人'
            ) {
                ...
                recordset.val(
                    '产品资料.外销合同',
                    recordset.val('产品资料.外销合同') + '赠送',
                )
                recordset.val('产品资料.外销单价', 0)
                recordset.val('产品资料.外销总价', 0)
                recordset.val('产品资料.赔款单价', 0)
                recordset.val('产品资料.客户RMB单价', 0)
                recordset.val('产品资料.赔款RMB', 0)
                recordset.val('产品资料.客户RMB总价', 0)
                recordset.val('产品资料.外销总价总', 0)
                recordset.val('产品资料.佣金单价', 0)
                recordset.val('产品资料.佣金比率', 0)
                recordset.val('产品资料.佣    金', 0)
                recordset.val('产品资料.暗佣比率', 0)
                recordset.val('产品资料.暗佣单价', 0)
                recordset.val('产品资料.暗佣佣金', 0)
                recordset.val('产品资料.客户RMB总价9', 0)
                recordset.val('产品资料.总 金 额9', 0)
                recordset.val('产品资料.佣金M', 0)
                recordset.val('产品资料.佣金R', 0)
                recordset.val('产品资料.外销总价总分', 0)
                recordset.val('产品资料.佣金R1', 0)
                recordset.val('产品资料.佣金M1', 0)
                recordset.val('产品资料.暗佣R1', 0)
                recordset.val('产品资料.暗佣M1', 0)
                recordset.val('产品资料.佣金R11', 0)
                recordset.val('产品资料.佣金M11', 0)
                recordset.val('产品资料.佣金总价', 0)
            }
            if (
                recordset.val('产品资料.赠送') == '是' ||
                recordset.val('产品资料.赠送') == '工厂'
                ...
                recordset.val('产品资料.配柜唯一', '')
                recordset.val(
                    '产品资料.采购合同',
                    recordset.val('产品资料.采购合同') + '赠送',
                )
                recordset.val('产品资料.采购单价', 0)
                recordset.val('产品资料.辅料价格', 0)
                recordset.val('产品资料.辅料总价', 0)
                recordset.val('产品资料.采购总价', 0)
            }
        }
    }
    if (field.full_name == m + '.产品资料.海关编码' && value != '') {
        let hgbm = recordset.val('产品资料.海关编码')
            ...
            _.http
                ...
                .then((res) => {
                    ...
                    if (d) {
                        ...
                        recordset.val('产品资料.申报要素', d.cznr)
                    }
                })
                .catch((err) => {
                    _.ui.message.error(err.msg)
    ...
    if (
        ...
        if (
            ...
            _.http
                ...
                .then((res) => {
                    let d = res.data
                    if (recordset.val('产品资料.代开点数') == 3) {
                        d = d / 100
                    } else {
                        d = recordset.val('产品资料.代开点数') / 100
                    }
                    recordset.val(
                        '产品资料.开票费用',
                        Math.round(recordset.val('产品资料.采购总价') * d * 1000) / 1000,
                    )
                })
                .catch((err) => {
                    _.ui.message.error(err.msg)
    ...
    if (field.full_name == m + '.预填情况.预填数量') {
        if (
            recordset.val('预填情况.预填数量') == recordset.val('产品资料.出运数量')
        ) {
            recordset.val('产品资料.数量有无差值', '无')
        } else {
            recordset.val('产品资料.数量有无差值', '有')
        }
    }
        ...
        if (
            ...
            _.http
                ...
                .then((res) => {
                    ...
                    if (recordset.val('产品资料.出货数量') != 0) {
                        if (recordset.val('产品资料.佣金比率') > 0 && d != 1) {
                            recordset.val(
                                '产品资料.佣    金',
                                zje * recordset.val('产品资料.佣金比率'),
                            )
                        } else {
                            if (recordset.val('产品资料.佣金单价') > 0) {
                                recordset.val(
                                    '产品资料.佣    金',
                        ...
                        if (recordset.val('产品资料.暗佣比率') > 0 && d != 1) {
                            recordset.val(
                                '产品资料.暗佣佣金',
                                zje * recordset.val('产品资料.暗佣比率'),
                            )
                        } else {
                            if (recordset.val('产品资料.暗佣单价') > 0) {
                                recordset.val(
                                    '产品资料.暗佣佣金',
 ...
 */
const shipment_set_if_empty = (recordset, fieldName, value) => {
                        ...
                        _.http
                            ...
                            .then((res) => {
                                ...
                                for (let r of v) {
                                    ...
                                    let cght = item.cght
                                    let gcmc = r.gcmc
                                    if (cght != '' && cght != null && cght in item) {
                                        let l = item.main
                                        if (l) {
                                            r[
            ...
            .then((res) => {
                ...
                for (let r of v) {
                    ...
                    if (
                        ...
                        if (dc12 < 0) {
                            ...
                            chxs12.Strings[dc12] =
                                Math.round(chxs12.strings[dc12]) +
                                Number(
                                    r[
                                        recordset.module.field_by_full_name('产品资料.箱    数').db
                                        .name
                            ...
                            zmz12.Strings[dc12] = round(
                                [
                                    Number(zmz12.strings[dc12]) +
                                    Number(
                                        r[
                            ...
                            if (
                                ...
                                ztjz12.Strings[dc12] = round(
                                    [
                                        Number(ztjz12.strings[dc12]) +
                                        Number(
                                            r[
                                                recordset.module.field_by_full_name(
                                                    '产品资料.总 体 积',
                    ...
                    if (khmc.toUpperCase().includes('AMAZON')) {
                        ...
                        cghtzs =
                            length(
                                r[
                                    recordset.module.field_by_full_name('产品资料.采购合同').db
                                    .name
                                ],
                            ) - 9

                        r[
                                recordset.module.field_by_full_name('产品资料.采购合同1').db.name
                            ] =
                            copy(
                                r[
                                    recordset.module.field_by_full_name('产品资料.采购合同').db
                ...
                if (recordset.val('合并识别') == '') {
                    for (let v in hb_data) {
                        ...
                        l.czwyz = k.czwyz
                        l.hgbm = k.hgbm
                        if (k.ysewz != '' && k.ysewz != null) {
                            l.ysewz = k.ysewz.toUpperCase()
                        }
                        l.rmbdjz = k.rmbdjz
                        l.rmbzjz = k.rmbzjz
                        if (k.bzdwz != '' && k.bzdwz != null) {
                            l.bzdwz = k.bzdwz.toUpperCase()
                        }
                        l.hgbm2 = k.hgbm2
                        l.khht = k.khht
                        l.caizi = k.caizi
                ...
                if (sb == 1 && xyzh != '无' && btsb == 0) {
                    _.ui.message.error('此客人有' + xyzh + '保险请注意')
                }
                if (sb == 1 && recordset.val('制单人员') == _.user.username) {
                    if (!fphm.includes('SFT')) {
                        if (recordset.val('更新识别') == '') {
                            _.ui.message.error('请注意此票没点产品资料——扩展——更新信息')
                        }
                    }
                    if (kpgc == 1) {
                        _.ui.message.error('此票存在有增税无开票工厂情况，请检查后保存')
                    }
                    if (kpsb == 1) {
                        _.ui.message.error('此票存在有增税无报关情况，请检查后保存')
                    }
                }
                hhcbz = 0
                    ...
                    if (recordset.val('只读状态') === '是') {
                        ...
                        if (recordset.val('提交判断') === '是') {
                            ...
                            if (
                                ...
                                _.ui.message.error(
                                    '请注意此票有市场金额,请填写市场模式抬头后保存!!',
                                )
                                sdsb = 1
                            }
                            if (recordset.val('保存识别') == '否') {
                                _.ui.message.error('请注意此票有错误操作,系统不能保存!!')
                                sdsb = 1
                            }
                            let wxhtsb = 0
                            if (!fphm.includes('SFT')) {
                                ...
                                if (
                                    ...
                                    if (
                                        (
                                            recordset.val('合同号码').toUpperCase().includes(fphm)==false &&
                            ...
                            if (wxhtsb == 1) {
                                sdsb = 1
                                _.ui.message.error("请注意合同号码【" + recordset.val('合同号码').toUpperCase() + "】错误或合同号码和发票号码【" + fphm + "】不符")
                            } else {
                                bb = 0
                                iy = 0
                                sfcy = '否'
                                ...
                                if (d.sfdz == 0) {
                                    ...
                                    if (!fphm.includes('SFT')) {
                                        if (
                                            ...
                                            _.ui.message.error('请输进港日期后在行保存')
                                            reject()
                                            return
                                        }
                                    }
                        ...
                        if (sdsb1 == 1) {
                            _.ui.message.error('有净重大于毛重产品，请检查后保存')
                        }
                        if (sdsb == 1 || sdsb1 == 1) {
                            reject('当前记录不能修改')
                            return
