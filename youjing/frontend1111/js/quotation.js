...
const quotation_field_change = (evt_id, opts) => {
            ...
            if (
                ...
                _.http
                    .post('/api/saier/items/get/size', {
                        xm: xm,
                        sz: recordset.value('产品资料.外箱体积', row),
                    })
                    .then(function (res) {
    ...
    if (field.full_name == n + '.产品资料.货号备注') {
        if (
            ...
            recordset.val('产品资料.上传识别') != '是' &&
            recordset.val('强制更新') != '采购单号' &&
            recordset.val('产品资料.货号备注') != ''
        ) {
            _.http
                ...
                .then(function (res) {
                    ...
                    // let path1 = d.path;
                    let zyhh1 = recordset.val('产品资料.专业货号').trim()
                    ...
                    if (d.cp) {
                        ...
                        if (recordset.val('产品资料.报价报价唯一字段1') == '')
                        ...
                        if (recordset.val('部门识别') == '1') {
                            ...
                            if (recordset.val('产品资料.客户货号') == '' && d.cp.krhh != '无')
                                recordset.val('产品资料.客户货号', d.cp.krhh, row)
                            if (recordset.val('产品资料.客人条码') == '')
                    ...
                    if (recordset.val('产品资料.专业厂家') != '' && d.cs) {
    ...
    _.http
        ...
        .then(function (res) {
            ...
            if (d.username != 'zhbblh') {
                ...
                if (recordset.val('业务人员') == '') {
                    recordset.val('业务人员', b)
                }

                if (recordset.val('外销部门') == '') {
                    recordset.val('外销部门', bm)
                }
            }
