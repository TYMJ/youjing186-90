...
logger.error(fn)
module_files = [f[:-3] for f in os.listdir(fn) if f.endswith('.py') and f != '__init__.py' and f != '__pycache__']

# 动态导入这些模块
for module_name in module_files:
    # logger.error(f"正在导入模块: {module_name}")
...
# from .commodity_inspection import *
...
# from .RMB_INV_pack_sales import *
# from .BUY_INV_pack_sales import *
# from .RMB_BUY_INV_pack_sales import *



# from .shipment_fees import *
# from .purchase_ap import *
# from .payment_merge import *
# from .cash_merge import *
# from .overhead_fees import *

# from .forwarder_expense import *
# from .shipment_amendment import *
